...
api_url = st.sidebar.text_input(
    "Backend API URL",
    "https://casemated-hazardously-elvera.ngrok-free.dev"  # You'll replace this with the ngrok URL from Colab
)
...
<div class="footer">
    Created with ❤️ by Mehfuz Alam | <a href="https://github.com/Mehfuz-alam" target="_blank">GitHub</a>
</div>
""",
